...
module.exports.run = async (bot, message, args) => {
    ...
    let startMessage = new Discord.RichEmbed()
        ...
        .setDescription("por favor escribe los ultimos 3 digitos")
        .setColor("#8600b3")
        .setURL("https://www.youtube.com/channel/UCfvRCC4_y2NelfMGjZLjzZA")
        .setFooter("SobrinoCangrejo");
    ...
    let timeEmbed = new Discord.RichEmbed()
        .setTitle("Siguiente partida en aproximadamente...")
